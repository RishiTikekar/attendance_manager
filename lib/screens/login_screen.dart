...
class _LoginScreenState extends State<LoginScreen>
  ...
  final Curve myCurve = Cubic(0.1, 0.2, 0.1, 1.0);
  ...
  void submitForm() async {
    ...
    if (form.validate()) {
      ...
      if (user.email == "admin@gmail.com") {
        ...
        Navigator.of(context).pushNamed(Routes.ADMIN_HOME_SCREEN);
      } else {
        ...
        if (isTeacher) {
          print('Redirect to teacher form');
          Navigator.of(context)
              .pushReplacementNamed(Routes.TEACHER_HOME_SCREEN);
        } else {
          print('Redirect to student form');
          Navigator.of(context)
              .pushReplacementNamed(Routes.STUDENT_HOME_SCREEN);
        }
      }
    }
